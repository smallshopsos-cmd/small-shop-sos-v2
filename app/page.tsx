...
<p className="burt-note">Use the Ask Burt button in the corner whenever you need him.</p>
</div>
</section>
...
<style>{`.pph-burt{display:grid;grid-template-columns:1fr 1fr;background:#eee9e5;border-top:1px solid var(--line);border-bottom:1px solid var(--line)}.pph-burt>div{padding:clamp(40px,5vw,72px) clamp(25px,7vw,100px)}.pph-burt h2{margin:0 0 14px;font:700 clamp(38px,4.4vw,66px)/.9 var(--display);letter-spacing:-.055em}.pph-side{background:#f6f3ef;color:var(--char)}.pph-side>p:not(.eyebrow){max-width:370px;margin:0 0 20px;font-size:13px}.pph-widget{min-height:320px;display:flex;justify-content:flex-start;align-items:center;margin:8px 0 14px}.burt-side{position:relative;overflow:hidden;background:var(--char);color:#fff}.burt-side .eyebrow{color:#dba6c0}.burt-side>p:not(.eyebrow){max-width:400px;color:#e5dfe3;font-size:13px}.burt-side .burt-note{color:#dba6c0;font:italic 20px/1.1 var(--display)}.burt-mark{position:absolute;right:clamp(25px,5vw,72px);top:32px;display:grid;place-items:center;width:72px;height:72px;border:1px solid #b7bcc366;border-radius:50%;color:#f6f3ef;font:700 44px/1 var(--display);box-shadow:inset 0 0 0 7px #5a2a4a}@media(max-width:800px){.pph-burt{grid-template-columns:1fr}.pph-side{order:1}.burt-side{order:2}.pph-widget{justify-content:center}.burt-mark{right:26px;top:26px;width:58px;height:58px;font-size:35px}}`}</style>
</>}
